...
Beyond the forums, also be sure to check out our [free video tutorials](http://videos.appcelerator.com/) which cover a wide range development topics related to Titanium, API Builder, and beyond.
...
We have support engineers monitoring this channel 24/7. Response times are made on a “best effort” best basis depending volumes, but we typically respond within 30 minutes. If you are not in the chat window when we respond, the reply will be emailed to you so you won’t miss it.
...
2.  Provide a detailed summary of your support request, such as:
    ...
    *   Version of the SDK, IDE, Modules etc.
