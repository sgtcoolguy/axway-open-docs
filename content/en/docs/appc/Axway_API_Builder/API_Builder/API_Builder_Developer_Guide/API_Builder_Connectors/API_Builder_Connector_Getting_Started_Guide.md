...
* [Develop the connector](#develop-the-connector)

    * [Add connect logic](#add-connect-logic)

    * [Add retrieve logic](#add-retrieve-logic)

    * [Add create logic](#add-create-logic)

    * [Add delete logic](#add-delete-logic)
