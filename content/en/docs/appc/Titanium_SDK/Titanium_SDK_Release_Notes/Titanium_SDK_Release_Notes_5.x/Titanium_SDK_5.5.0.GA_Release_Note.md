{"title":"Titanium SDK 5.5.0.GA - 13 September 2016","weight":"20"}
...
* [Notice of Feature and Behavior Changes](#notice-of-feature-and-behavior-changes)
    ...
    * [Using Facebook module with iOS 10 and Xcode 8](#using-facebook-module-with-ios-10-and-xcode-8)

    * [Using iOS Hyperloop with more than one version of Xcode installed](#using-ios-hyperloop-with-more-than-one-version-of-xcode-installed)

* [New Features major/minor releases](#new-features-major/minor-releases)
