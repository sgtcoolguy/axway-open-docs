...
{{% alert title="⚠️ Warning" color="primary" %}}###### Back up your private key
...
5. You can now transfer this .p12 file between systems. Double-click on the .p12 file to install it on a system. You will be prompted for the password you entered above.{{% /alert %}}
