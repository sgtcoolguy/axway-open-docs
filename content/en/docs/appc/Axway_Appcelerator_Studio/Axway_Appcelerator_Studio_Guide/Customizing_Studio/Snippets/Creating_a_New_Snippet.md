...
The basics are that ruby code surrounded with #{} is interpreted and inserted into the string. References to globals, i.e. $my\_global, will be interpreted even if not surrounded by #{}. You should escape $ like so:
