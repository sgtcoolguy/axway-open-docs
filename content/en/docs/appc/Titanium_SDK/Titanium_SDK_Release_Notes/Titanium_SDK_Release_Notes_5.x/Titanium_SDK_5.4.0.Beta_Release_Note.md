{"title":"Titanium SDK 5.4.0.Beta - 13 July 2016","weight":"70"}
...
As of this release, Titanium SDK 5.3.x will not be supported six months from 5.4.0.GA's release date. See [Axway Appcelerator Deprecation Policy](/docs/appc/AMPLIFY_Appcelerator_Services_Overview/Axway_Appcelerator_Deprecation_Policy/) and [Nominal Lifetimes](/docs/appc/AMPLIFY_Appcelerator_Services_Overview/Axway_Appcelerator_Product_Lifecycle/#nominal-lifetimes) documents for details.
...
| Titanium.Media.AUDIO\_SESSION\_MODE\_AMBIENT | property | Deprecated in favor of the AUDIO\_SESSION\_CATEGORY constants defined in Titanium.Media. |
| Titanium.Media.AUDIO\_SESSION\_MODE\_PLAYBACK | property | Deprecated in favor of the AUDIO\_SESSION\_CATEGORY constants defined in Titanium.Media. |
| Titanium.Media.AUDIO\_SESSION\_MODE\_PLAY\_AND\_RECORD | property | Deprecated in favor of the AUDIO\_SESSION\_CATEGORY constants defined in Titanium.Media. |
| Titanium.Media.AUDIO\_SESSION\_MODE\_RECORD | property | Deprecated in favor of the AUDIO\_SESSION\_CATEGORY constants defined in Titanium.Media. |
