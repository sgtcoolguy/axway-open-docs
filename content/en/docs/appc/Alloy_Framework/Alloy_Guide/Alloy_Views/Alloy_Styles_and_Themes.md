...
Alternatively, you can create subfolders, named as the platform, in the styles directory as another way to create platform-specific styles. Refer to [Alloy Concepts: Platform-Specific Resources](/docs/appc/Alloy_Framework/Alloy_Guide/Alloy_Concepts/#Platform-specificresources).
...
Alloy 1.7.6 / CLI 5.0.0

merges folders and files

assets

merges folders, overwrites files
...
themes/<theme\_name>/styles/app.tss
...
themes/<theme\_name>/styles/<platform>/app.tss

**OR**

themes/<theme\_name>/styles/app.tss with the \[platform=<platform>\] syntax

View-Controller Style File

styles/<view\_controller>.tss

View-Controller Style File in a Theme

themes/<theme\_name>/styles/<view\_controller>.tss

View-Controller Style File with Platform-Specific Styles

styles/<platform>/<view\_controller>.tss

**OR**

styles/<view\_controller>.tss with the \[platform=<platform>\] syntax

View-Controller Style File in a Theme with Platform-Specific Styles

themes/<theme\_name>/styles/<platform>/<view\_controller>.tss

**OR**

themes/<theme\_name>/styles/<view\_controller>.tss with the platform attribute

XML Markup

views/<view\_controller>.xml

XML Markup with Platform-Specific Styles

views/<platform>/<view\_controller>.xml

**OR**

views/<view\_controller>.xml with the platform attribute