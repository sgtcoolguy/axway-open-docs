...
* [Concepts](#concepts)
    ...
    * [View Organization details, applications, and members](#view-organization-details,-applications,-and-members)

* [Managing an organization](#managing-an-organization)

* [Managing organization members](#managing-organization-members)

    * [Add an organization member](#add-an-organization-member)

    * [Viewing and modifying a member's role or access](#viewing-and-modifying-a-member's-role-or-access)
...
* [Managing teams](#managing-teams)
    ...
    * [Set a team as default](#set-a-team-as-default)

    * [Remove a team](#remove-a-team)

* [Managing child organizations](#managing-child-organizations)

* [Managing usage](#managing-usage)
